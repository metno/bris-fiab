...
def cli(topography_file: str, original_checkpoint: str, create_checkpoint: str, save_graph_to: str, lam_resolution: int, global_resolution: int, margin_radius_km: int):
    graph.run(
