...
@click.option(
    ...
    type=str,
    required=True,
    help="Bounding box coordinates as (north/west/south/east)",
)
@click.option(
    "--api-key-file",
    ...
    default=None,
    show_default=False,
    help="Path to JSON file containing the API key",
)
@click.option(
    "--dem-type",
    type=click.Choice(["SRTMGL3", "SRTMGL1", "AW3D30", "TDM1", "COP30"]),
    default="SRTMGL3",
    show_default=True,
    help="Type of DEM to download",
)
@click.argument("dest")
